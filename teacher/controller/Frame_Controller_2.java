...
public class Frame_Controller{	
	...
	public Object data(@PathVariable("service")String service,
		...
		case "sub_date_btn":
			...
			bean.setGroupno(groupNo);
			res = repository.getSubDate(bean);
			break;
		...
		case "sub_leader_btn":
			...
			bean.setGroupno(groupNo);
			res = repository.getSubLeader(bean);		
			break;
	
		case "sub_follower_btn":
			if(logged == true){
				  groupNo = bean.getGroupno();
			}else{
				  groupNo=Integer.parseInt(request.getParameter("groupno"));
			...
			bean.setGroupno(groupNo);
			res = repository.getSubFollower(bean);	
			break;
		...
		case "displayContentByTitle" : 		
			...
			if(logged == true){
				...
				bean.setTitleno(Integer.parseInt(request.getParameter("titleno")));
	...
	public String view(@PathVariable("sub") String sub, 
		...
		if(service.equals("subPaging")
		  ||service.equals("prevsubPaging")	  
		){
			    return "/main/frame/subPaging";
		}else if( service.equals("sub_date_btn")
				  ||service.equals("sub_leader_btn")
				  ||service.equals("sub_follower_btn")
				  ||service.equals("displayContentByTitle")
				){
